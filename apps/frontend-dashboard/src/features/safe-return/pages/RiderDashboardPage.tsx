          ...
          <CardContent sx={{ p: 4 }}>
            ...
            <Grid container spacing={3} sx={{ mb: 4 }}>
              <Grid size={{ xs: 12, sm: 6 }}>
                ...
                <Typography variant="h6" sx={{ fontWeight: 'medium' }}>{activeSession.destination}</Typography>
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
            ...
            {timeLeft !== null && (
              <Box sx={{ p: 3, bgcolor: timeLeft < 300 ? '#ffebee' : '#e8f5e9', borderRadius: 2, mb: 4, textAlign: 'center' }}>
                <Typography variant="h4" color={timeLeft < 300 ? 'error.main' : 'success.main'} sx={{ fontWeight: 'bold' }}>
